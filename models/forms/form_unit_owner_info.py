...
class VehicleInfoForm(models.Model):
    ...
    cert_registration_no = fields.Char(string="Certificate of Registration Number")
    new_sticket_no = fields.Char(string="New Vehicle Sticker Number")
    ...
    def _get_template(self):
        ...
        if not template:
            ...
            pdf_content, _ = self.env["ir.actions.report"]._render_qweb_pdf(
                "pms.action_unit_owner_info_sign_default", [self.id]
            )
            # Attachment
